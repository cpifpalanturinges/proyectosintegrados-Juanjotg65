            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="reservation">Consulta sobre reserva</option>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Calle Principal 123, 28001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@gt-turing.com" className="text-blue-600 hover:text-blue-700">
                      info@gt-turing.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+34900123456" className="text-blue-600 hover:text-blue-700">
                      +34 900 123 456
                    </a>
                  </div>
                </div>
