        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LengthMeters = table.Column<int>(type: "INTEGER", nullable: false),
                    WidthMeters = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: false),
                    SurfaceType = table.Column<string>(type: "TEXT", nullable: false),
                    ElevationChange = table.Column<int>(type: "INTEGER", nullable: true),
                    NumberOfCorners = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupTime = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Circuits_CircuitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Circuits_IsAvailable",
                table: "Circuits",
                column: "IsAvailable");

            migrationBuilder.CreateIndex(
                name: "IX_Circuits_Province",
                table: "Circuits",
                column: "Province");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CircuitId",
                table: "Reservations",
                column: "CircuitId");
